        ...
        <div class="page-footer">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <span class="txt-color-white"><a href="<?php echo site_url('change-log'); ?>" target="_blank" style="color: white;" title="show change log">V 
                    <?php echo $log['log_curr_version'];?></a> <span class="hidden-xs"></span> © PT SUDARTA CONSULTING 2018-<?= date('Y');?></span>
                </div>
            </div>
        </div>
		...
		<div id="shortcut">
			<!-- <ul>
                ...
                <li>
					<a href="<?php// site_url(); ?>admin/change_password" class="jarvismetro-tile big-cubes bg-color-blue"> <span class="iconbox"> <i class="fa fa-key fa-4x"></i> <span>Change Password </span> </span> </a>
				</li>
			</ul> -->
		</div>
		<!-- END SHORTCUT AREA -->
