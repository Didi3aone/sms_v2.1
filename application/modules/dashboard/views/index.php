    	...
    	<!-- <marquee style="font-family:Book Antiqua; color: #FFFFFF" scrollamount="8">	 -->
			<div class="col-md-6">
				<div class="alert alert-info alert-dismissible fade in" style="margin-left: 10px;">
				    ...
				    <strong><?= greeting(); ?>!</strong> <b>( <?= $this->session->userdata('name'); ?> )</b> Welcome to SYSTEM APPLICATION SMS V <?= $log['log_curr_version']; ?> 
				  </div>
			</div>
		<!-- </marquee> -->
	</div>
		...
		<div class="wrimagecard wrimagecard-topimage">
			<a href="#">
				...
				<div class="wrimagecard-topimage_title">
					<h4>Total Sent
						<div class="pull-right badge"><?php// $sent['total']; ?></div>
					</h4>
				</div>
			</a>
		</div>
	...
	<!-- <div class="col-md-3 col-sm-4">
		<div class="wrimagecard wrimagecard-topimage">
			<a href="#">
				...
				<div class="wrimagecard-topimage_title">
					<h4>Total Inbox
						<div class="pull-right badge" id="WrControls"> <?php// $inbox['total'] ?> </div>
					</h4>
				</div>
			</a>
		</div>
	...
	<!-- <div class="col-md-3 col-sm-4">
		<div class="wrimagecard wrimagecard-topimage">
			<a href="#">
				...
				<div class="wrimagecard-topimage_title">
					<h4>Total Failed
						<div class="pull-right badge" id="WrControls"> <?php// $out['total']; ?> </div>
					</h4>
				</div>
			</a>
		</div>
