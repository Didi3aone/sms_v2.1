			...
			<article class="col-sm-12 col-md-12 col-lg-12">
				...
				>
					<header>
						...
						<h2> Replay SMS To <b>( <?=  ($inbox_row['Emp_Name']) ? strtoupper($inbox_row['Emp_Name']) : strtoupper($inbox_row['SenderNumber']); ?> )</b></h2>
					</header>
					...
					<div>
						<div class="widget-body widget-hide-overflow no-padding">
							...
							<div class="chat-footer">
								<form method="post">
									<input type="hidden" name="nomor" id="nomors" value="<?= $inbox_row['SenderNumber'] ?>">
									<div>
										 Pilih Template
										<label class="select">
