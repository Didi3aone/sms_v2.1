    	...
    	*/
        ...
        public function list_all_data() {
            ...
            $select = array(
                ...
                'IF(user_is_state = 1,"ONLINE","OFFLINE") as state_act',
        ...
        {
            // $id = $this->session->userdata("user_id");
            $this->load->model(array('Chat_model','Dynamic_model'));
                ...
                '<div class="pull-right" id="chat_show" margin-right: 10px; st margin-top: 10px;">
                    <div class="alert alert-success">
                        <a data-id="'.$data['ChatId'].'" class="close klik" data-dismiss="alert" aria-hidden="true">
                            ×</a>&nbsp;
                       <span class="glyphicon glyphicon-bell"></span <strong>Notifications &nbsp;</strong>
